...
const Services = () => {
    ...
    return (
        <div className="conainer">
            <div className="row">
                <div id="Service" className='service d-flex' data-aos="fade-up" data-aos-duration="2000">
                ...
                <div className="sepcialdata1" data-aos="fade-up" data-aos-duration="2000">
                ...
                <div className="sepcialdata2 mt-3" data-aos="fade-up" data-aos-duration="2000">
